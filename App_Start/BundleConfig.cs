...
namespace BlossomWeb
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jeasyuidetail").Include(
                "~/Scripts/jquery-easyui-1.4/jquery.easyui.min.js",
                "~/Scripts/jquery-easyui-1.4/jquery.min.js",
